	...
	CommandLineRunner init(UsuariosRepository UsuariosRepository, AgendamentosRepository AgendamentosRepository,
		...
		return args -> {
			...
			AgendamentosRepository.saveAll(
					java.util.Arrays.asList(
							new Agendamento(null, LocalDate.parse("2023-11-01"), LocalTime.parse("13:00:00"),
									LocalTime.parse("15:00:00"), 1, "mesa", 3),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 1, "mesa", 1),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 2, "mesa", 2),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 2, "mesa", 3),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 3, "mesa", 4),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 3, "mesa", 5),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 4, "mesa", 6),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 4, "mesa", 7),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 5, "mesa", 8),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 5, "mesa", 9),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 6, "mesa", 10),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 6, "mesa", 11),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 7, "mesa", 12),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 7, "mesa", 13),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 7, "mesa", 14),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 7, "mesa", 15),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("14:00:00"),
									LocalTime.parse("15:00:00"), 7, "mesa", 16),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("09:00:00"),
									LocalTime.parse("10:00:00"), 2, "maquina", 1),
							new Agendamento(null, LocalDate.parse("2023-12-04"), LocalTime.parse("10:00:00"),
