		...
		return args -> {
			...
			AgendamentosRepository.saveAll(
					java.util.Arrays.asList(
							...
							new Agendamento(null, LocalDate.parse("2023-12-05"), LocalTime.parse("14:00:00"),
							...
							new Agendamento(null, LocalDate.parse("2023-12-05"), LocalTime.parse("10:00:00"),
									LocalTime.parse("11:00:00"), 2, "maquina", 3),
							new Agendamento(null, LocalDate.parse("2023-12-05"), LocalTime.parse("17:00:00"),
									LocalTime.parse("18:00:00"), 1, "laboratorio", 2),
